...
* 금융 데이터 분석
  * "주가 예측" 은 데이터를 활용하여 종목의 주가를 예측하는 주제입니다.  
    ...
    참고 https://www.facebook.com/groups/939204776216857/permalink/1248791541924844/  
  * "주식종목 군집분석" 은 데이터를 활용하여 종목군을 생성하기 위해 군집분석하는 주제입니다.
  * "금융 소셜데이터 텍스트 마이닝" 은 데이터를 활용하여 종목의 의견 및 시장 의견을 분석, 인사이트를 하는 주제입니다.
* 금융 서비스 개발
